...
const RightPanel = ({
    ...
    return (
      <div style={{ padding: "1rem", width: "300px", borderLeft: "1px solid #ccc" }}>
        <div style={{ marginBottom: "2rem" }}>
          <h2>Configuration</h2>
          <div style={{ marginBottom: "1rem" }}>
            <label>Screen</label>
            <select onChange={(e) => onSelectionChange("model", models[e.target.selectedIndex])}>
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            <select onChange={(e) => onSelectionChange("mediaPlayer", mediaPlayers[e.target.selectedIndex])}>
          ...
          <div style={{ marginBottom: "1rem" }}>
            <label>Mount</label>
            <select onChange={(e) => onSelectionChange("mount", mounts[e.target.selectedIndex])}>
          ...
          <div style={{ marginBottom: "1rem" }}>
            ...
            <select onChange={(e) => onSelectionChange("receptacle", receptacles[e.target.selectedIndex])}>
        ...
        <div>
          ...
          <button style={{ width: "100%", backgroundColor: "blue", color: "white" }}>
            Download
          </button>
        </div>
      </div>
